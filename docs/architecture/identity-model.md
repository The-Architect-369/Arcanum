...
Identity exists prior to the system and persists beyond it.
...
No state change elsewhere in the system may redefine identity.
...
The \*\*Chain Code\*\* is the system’s mechanism for witnessing identity.
...
It is a witness of continuity, not a container of being.
...
Identity spans layers with strict authority boundaries:
...
No other layer may assert identity authority.
...
Only lived experience determines who a being is.
...
Identity remains sovereign regardless of system participation.
...
A being is not their recognitions.



Loss, change, or silence in Vitae does not diminish identity.
...
Economic activity has no bearing on who a being is.
...
Identity persists across cycles, windows, and phases.
...
Only the minimum necessary surface is exposed for continuity and interaction.



No complete representation of identity may exist.
...
Identity is violated if any of the following occur:
...
Identity integrity is enforced through:

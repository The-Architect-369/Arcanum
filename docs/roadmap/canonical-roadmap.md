...
- One wave has one bounded purpose.
- Planning approval is not execution authorization.
- Work is described according to the branch where it actually exists.
...
The milestone is complete when one Android installation can, without internet access:

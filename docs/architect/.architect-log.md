...
- Treasury Spec File: `ArchitectGPT_Treasury_Spec.md` — v1.0  
...
### **Change Highlights**
- Added new canonical file: `ArchitectGPT_Treasury_Spec.md`  
...
ArchitectGPT_Treasury_Spec.md: version: 1.0
ArchitectGPT_Treasury_Spec.md: sync_status: synchronized_with_Core_v2.1_and_Extended_v2.1

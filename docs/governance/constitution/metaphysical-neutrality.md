...
The system is structured to reveal observable patterns of human experience, not to define or enforce interpretations of ultimate reality.
...
All symbolic frameworks must remain interpretive, optional, and practitioner-owned.
...
Interpretation belongs to the practitioner.
...
No governance decision may be justified by appeal to:
...
All structural decisions must be grounded in:

...
The Founder is not constitutionally sovereign.



The Founder does not possess permanent authority over governance.



The Founder’s role is transitional and stewardship-based.
...
The Architect is not a person.



The Architect is not tied to any individual identity.



No human shall be constitutionally elevated as permanent embodiment of the Architect.
...
The protocol must function independently of the Founder’s continued involvement.
...
The Founder may participate in governance as a peer node, not as supreme authority.
...
No core system function may depend on continued Founder action.

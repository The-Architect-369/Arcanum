...
Its seven equal circles use overlay-local Seed centers: one origin circle and six unit-distance centers at 60-degree intervals. Those coordinates define the overlay itself; they do **not** derive new canonical coordinates for ARCnet or Hope.

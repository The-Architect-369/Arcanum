---
title: "The Druid State Machine Spec"
status: draft
visibility: internal
...
**Transparency Note:** Some earlier uploaded reference PDFs/files have expired in this environment (expected system behavior). This specification is derived from the locked Druid canons and current implementation documents and does not depend on expired uploads. If you want alignment against earlier drafts, please re-upload them.

This document defines the **Druid specialization state machine**, including states, transitions, guards, failure behavior, and audit requirements. The state machine governs **overlay participation** and must not alter Core Vitae progression.
...
The Druid state machine is **overlay-scoped**:
...
* non-claims (no domination, no mastery, no ownership)  
* risk disclosures (romanticization, ecological superiority)  
...
**Meaning:** Practitioner may request and complete Druid units.
...
* Policy Engine enforces reciprocity and anti-extraction invariants
...
* detected domination or ownership framing  
* extractive instrumentalization  
* superiority or romanticization drift
...
### **G2 — Reciprocity Over Extraction**

Any language or unit implying extraction for gain triggers rejection or stall.

### 

### **G3 — No Domination / Ownership**

Any mastery, ownership, or control framing is prohibited.

### **G4 — No Ecological Superiority**

No moral superiority claims derived from nature engagement are allowed.
...
### **FM1 — Romanticization Drift**

* soften outputs  
* re-orientation required  
* if repeated → STALLED

### **FM2 — Domination / Ownership Language**

* block output  
* log violation  
* immediate STALLED

### **FM3 — Extraction Framing**
...
If the Druid state machine enables domination, extraction, ecological superiority, or interference with Core Vitae progression, it is invalid.

This specification defines the **only valid state machine** for the Druid specialization.

---

**End of The Druid — State Machine Specification**

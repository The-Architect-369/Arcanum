---
title: "The Illusionist State Machine Spec"
status: draft
visibility: internal
...
# The Illusionist State Machine Spec
...
**Transparency Note:** Some earlier uploaded reference PDFs/files have expired in this environment (expected system behavior). This specification is derived from the locked Illusionist canons and the current implementation documents and does not depend on expired uploads. If you want alignment against earlier drafts, please re-upload them.

This document defines the **Illusionist specialization state machine**, including states, transitions, guards, failure behavior, and audit requirements. The state machine governs **overlay participation** and must not alter Core Vitae progression.
...
The Illusionist state machine is **overlay-scoped**:
...
* non-claims (no truth, no superiority, no diagnosis)  
* risk disclosures (authority drift via perception)  
...
**Meaning:** Practitioner may request and complete Illusionist units.
...
* Policy Engine enforces observation-only and anti-superiority invariants
...
* detected interpretive authority drift  
* superiority cues  
* labeling/diagnostic attempts
...
* diagnosis  
* interpretation  
* correction triggers rejection or stall.
...
* “seeing the truth”  
* “more awake”  
* “higher awareness” triggers rejection and may stall.
...
### **FM1 — Interpretive Drift**

* soften outputs  
* re-orientation required  
* if repeated → STALLED

### **FM2 — Superiority Narratives**

* block output  
* log violation  
* immediate STALLED

### **FM3 — Diagnostic Labeling**
...
If the Illusionist state machine enables perceptual superiority, interpretive authority, or interference with Core Vitae progression, it is invalid.

This specification defines the **only valid state machine** for the Illusionist specialization.

---

**End of The Illusionist — State Machine Specification**

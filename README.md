...
- CE-W03: complete / certified / promoted
- Current implementation wave: **CE-W03 — Hope at the Center / Arcanum Native Vertical Slice — complete/certified**
- Next evidence-gated wave: **CE-W04 — Seed Node Alpha**
...
- `runtime/arcanum-hope-runtime/` — closed Construction Hope record/namespace contract
- `runtime/arcanum-android-*` — bounded Android/JNI runtime adapters, including the isolated Hope JNI bridge
...
1. `docs/repo/arcanum-baseline.md` — encoded Construction baseline through CE-W03
2. `docs/specs/app/ce-w03-native-hope.md` — CE-W03 implementation contract and CE-W04 boundary

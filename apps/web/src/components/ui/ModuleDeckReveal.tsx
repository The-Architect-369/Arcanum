...
export default function ModuleDeckReveal() {
  ...
  const reveal = (key: string) => {
    ...
    window.requestAnimationFrame(() => {
      setModuleKey(key);
      timerRef.current = window.setTimeout(() => setModuleKey(null), 520);
    });
  };
  ...
  return (
    <div className="module-deck-reveal pointer-events-none fixed inset-0 z-[60] grid place-items-center overflow-hidden bg-black/20 backdrop-blur-[1px]" aria-hidden="true">

...
export type VitaeFamilyId = 'path' | 'map' | 'record';
type CardId = string;
...
const FAMILY_BY_HREF: Record<(typeof ORDER)[number], VitaeFamilyId> = {
  '/vitae/path': 'path',
  '/vitae/grade': 'map',
  '/vitae/mastery': 'record',
};
const FAMILY_INDEX: Record<VitaeFamilyId, number> = {
  path: 0,
  map: 1,
  record: 2,
};
...
function familyFromPathname(pathname: string): VitaeFamilyId | null {
...
function motionForFamilyChange(from: VitaeFamilyId, to: VitaeFamilyId): FamilyMotion {
